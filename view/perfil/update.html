    ...
    <section id="banner">
      ...
      <section id="main" class="container 75%">
        <div class="box">
          <div class="12u">
            ""
            <input id="" name="" type="text" value="" placeholder="Nombre del restaurante">
          </div>
          <div class="12u">
            ""
            <input id="" name="" type="text"  value="" placeholder="Slogan">
          </div>
          <div class="12u">
            ""
          ...
          <div class="12u">
            ""
            <input id="" name="" type="text"  value="" placeholder="Domicilio completo">
          </div>
          <div class="12u">
            ""
            <input id="" name="" type="number"  value="" placeholder="Telefono">
          </div>
          <div class="12u">
            ""
            <input id="" name="" type="text"  value="" placeholder="Horario">
          </div>
        </div>
        <div class="12u" style="text-align: right;" >
          <ul class="actions">
            <li>
              <a class="button special " style="background: gray; display:scroll; position:fixed; bottom:50px; right:35px;" href="update.html">Guardar Cambios</a>
            </li>
          </ul>
        </div>
      </div>
